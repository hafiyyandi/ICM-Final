//create paths of intersections within a crest
...
function createIntersections(source) {
    ...
    //a combination is a pairing of two or more paths from source
    //the combination sequence makes sure all intersections are accounted for.
    ...
    for (let i = 0; i < sequence.length; i++) {
        if (sequence[i].length == 1) {
            ...
            while (b_pos < str.length) {
                ...
                if (ab == null) { //if combination doesn't exist, create new interesections within combination
