...
function classify_as_mohammad() {
    ...
    let source = 'passports/p' + photo_index + 'c.png';
    $('#passport').css('background-image', 'url(' + source + ')');

    //let imgelement = '<img src="' + source + '" id="passport">'
    //$('#print_job').html(imgelement);
...
function classify_as_not_mohammad() {
    ...
    let source = 'passports/p' + photo_index + 'o.png';
    $('#passport').css('background-image', 'url(' + source + ')');
    //let imgelement = '<img src="' + source + '" id="passport">'
    //$('#print_job').html(imgelement);
...
function loadtime() {
    if (load_progress < 100) {
        ...
        let photo_source = 'mohs/w-' + photo_index + '.jpg';
